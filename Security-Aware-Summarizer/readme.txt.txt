...
The predictions are saved in eval_2 folder where further analysis has been done where we see utilizing the Llama guard that the benign and ambiguous prediction responses by various LLMs ARE SAFE OR NOT.